...
const accountSid = 'ACb8bb987c0c693ca5d9e1140c7d8f7386';
const authToken = '2aa00822c63c40d46e13579fff888e72';
...
const mailOptions = {
  ...
  text: mailText
        ...
        try {
          ...
          const twilioMessage = await client.messages.create({ body: smsMessage, from: '+13158094462', to: '+91'+cellCValue });
